...
public class Edit_Answer_from_your_ans extends Activity {
    String Querry,scientist_number,answer,farmerId,Answer,query,ans;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit__answer_from_your_ans);
        Intent i1 =getIntent();
        Bundle data = i1.getExtras();
        Querry = data.getString("querry");
        farmerId = data.getString("farmerNumber");
        Answer = data.getString("Prev_Ans");
    ...
    public void answerit(View view) {
        if(answer_txt.getText().toString().isEmpty()){
            Toast.makeText(Edit_Answer_from_your_ans.this, "Type Your answer", Toast.LENGTH_SHORT).show();
        }
        else{
    ...
    public void update() {
        PD = new ProgressDialog(Edit_Answer_from_your_ans.this);
        PD.setMessage("please wait.....");
        PD.setCancelable(false);
        PD.show();
        answer = answer_txt.getText().toString();
        String prev_ans=null;
        try {
            ans= URLEncoder.encode(answer, "utf-8");
            query= URLEncoder.encode(Querry, "utf-8");
            prev_ans= URLEncoder.encode(Answer, "utf-8");
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
        }

        String update_url = "http://192.168.43.17/scientist_portal/new_answer_from_prev.php/?querry="
                + query + "&&answer=" + ans+"&&scientist_number="+scientist_number+"&&farmer_Number="+farmerId+"&&prev_ans="+prev_ans;
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        Intent intent = new Intent(Edit_Answer_from_your_ans.this,
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_edit__answer_from_your_ans, menu);
        return true;
    }
    @Override
